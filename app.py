...
from modulos.reporte_ventas import reporte_ventas  # Importar el módulo de reporte de ventas
...
def menu_principal():
    ...
    # Submenús según macro módulo
        ...
        if st.button("📊 Reporte de Ventas"):
            st.session_state.module = "ReporteVentas"
            st.rerun()
...
def cargar_modulo():
    if "module" in st.session_state:
        if st.session_state.module == "Ventas":
            ...
            modulo_inventario()
        elif st.session_state.module == "ReporteVentas":
            reporte_ventas()  # Cargar el reporte de ventas
        else:
            menu_principal()
    else:
        menu_principal()
